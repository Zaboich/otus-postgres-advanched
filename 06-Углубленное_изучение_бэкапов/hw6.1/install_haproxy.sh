...
sudo sed -i "s/{IP_ADDR1}/${IP_ADDR1}/g" /etc/haproxy/haproxy.cfg
sudo sed -i "s/{IP_ADDR2}/${IP_ADDR2}/g" /etc/haproxy/haproxy.cfg
sudo sed -i "s/{IP_ADDR3}/${IP_ADDR3}/g" /etc/haproxy/haproxy.cfg
